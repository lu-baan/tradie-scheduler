...
### Trade Scheduler 2 (`artifacts/trade-scheduler`)
- React + Vite frontend at previewPath `/`
- Full-featured scheduling app for Australian tradespeople
...
- Workers table in DB, jobs table with jobType/validityCode/isEmergency/numTradies/callUpTime
