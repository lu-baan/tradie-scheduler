          ...
          <div className="sm:border-r border-b sm:border-b-0 border-border">
            <DayPicker
              ...
              classNames={{
                ...
                nav: "flex gap-1",
                button_previous: "h-7 w-7 rounded-md border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-accent transition-colors",
                button_next: "h-7 w-7 rounded-md border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-accent transition-colors",
                month_grid: "w-full border-collapse",
                weekdays: "flex",
                weekday: "w-9 text-center text-[11px] text-muted-foreground font-medium",
                week: "flex mt-1",
                day: "w-9 h-9 text-center text-sm p-0 relative",
                day_button: "w-9 h-9 rounded-full flex items-center justify-center text-sm font-medium hover:bg-accent transition-colors cursor-pointer",
                selected: "bg-primary text-primary-foreground hover:bg-primary",
                today: "font-bold text-primary",
                outside: "text-muted-foreground opacity-30",
                disabled: "text-muted-foreground opacity-20 cursor-not-allowed hover:bg-transparent",
                hidden: "invisible",
              }}
            />
          </div>
